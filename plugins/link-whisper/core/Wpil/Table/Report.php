...
class Wpil_Table_Report extends WP_List_Table
{
                            ...
                            foreach ($links_data as $link) {
                                ...
                                $rep .= '<li>
                                            <div>
                                                ...
                                                <div style="margin: 3px 0;"><b>Anchor Text:</b> ' . esc_html(strip_tags($link->anchor)) . '</div>';
                                $rep .=         self::get_dropdown_icons($item['post'], $link->url, 'outbound-internal');
                                $rep .=     '</div>
                                        </li>';
                            }
                            ...
                            foreach ($links_data as $link) {
                                    ...
                                    $rep .= '<li>
                                                <div>
                                                    <div style="margin: 3px 0;"><b>Link:</b> <a href="' . esc_url($link->url) . '" target="_blank" style="text-decoration: underline">' . esc_html($link->url) . '</a></div>
                                                    <div style="margin: 3px 0;"><b>Anchor Text:</b> ' . esc_html(strip_tags($link->anchor)) . '</div>';
                                    $rep .=         self::get_dropdown_icons($item['post'], $link->url, 'outbound-external');
                                    $rep .=     '</div>
                                            </li>';
                            }
     ...
     * @param object $post
     **/
    function get_dropdown_icons($post = array(), $url = '', $disposition = 'inbound-internal'){
        $icons = '';
        $stats = array();
